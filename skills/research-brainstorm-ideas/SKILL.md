...
Once the user selects ideas they want to keep, offer to save them — but let the user name the file and location. A natural next step is `research-frame-research` to sharpen whichever idea the user picks.
