...
- See `design-experiments/SKILL.md` "Choose baselines — the fair way" for the full protocol.
...
**Fix patterns:**
- Iterate the abstract 5+ times — see `write-paper/references/section-abstract.md`.
...
- Acknowledge limitations explicitly — see `write-paper/SKILL.md` "Acknowledge weaknesses" principle.
...
- See `write-paper/references/section-related-work.md` "Fairness to prior work" for examples.

---

## ML-era additions

The above 10 are universal across CS publishing. The modern ML era adds specific failure modes (covered fully in `design-experiments/references/ml-evaluation-pitfalls.md`):
