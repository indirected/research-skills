...
The failure modes that most commonly sink ML papers at top venues right now. Loaded by `design-experiments/SKILL.md` and referenced by `review-paper/SKILL.md`.
