...
Read `research-design-experiments/references/ml-evaluation-pitfalls.md` if you haven't — these failure modes are the most common reviewer concerns:
...
- Use the experiment plan from `research-design-experiments` as the structural backbone — every experiment in that plan should be reflected in the section.
