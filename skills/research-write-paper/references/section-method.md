...
This supports the reproducibility checklist in `research-design-experiments`. If it's not in the method section, make sure it's somewhere — the appendix is fine.
...
- Use `research-frame-research` output for the high-level "what this method computes and why" framing.
- Use `research-design-experiments` for the reproducibility-detail level: anything in the design plan that affects results should be reflected in the method section.
